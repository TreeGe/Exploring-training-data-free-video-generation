...
if __name__=="__main__":
    ...
    parser.add_argument('--prompt_str', type=str, default='A tree in spring')
    ...
    rec_pil[0].save(f"output/test/{args.random_seed}_rec.png")
    for i in range(0,1):        
        (edit_pil[i])[0].save(os.path.join(args.results_folder, f"2_{i}.png"))
